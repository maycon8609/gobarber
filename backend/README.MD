...
- O usuário não pode alterar seu email para um e-mail já ultilizado;
...
- O usuário deve poder listar os dias do mês disponiveis ao selecionar um prestador;
- O usuário deve poder listar os horarios disponiveis ao selecionar um dia específico de um prestador;
- O usuário deve poder realizar um novo agendamento com um prestador;

**RNF**

- A listagem de prestadores deve ser armazenada am cache;
